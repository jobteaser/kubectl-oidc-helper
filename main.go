...
func cmd() *cobra.Command {
	...
	c.Flags().StringVar(&a.clientSecret, "client-secret", "some-secret", "OAuth2 client secret of this application.")
...
func (a *app) handleCallback(w http.ResponseWriter, r *http.Request) {
	...
	claimData := Claim{}
	err = idToken.Claims(&claimData)
	if err != nil {
		fmt.Println("Error decoding claims")
	}
	renderToken(w, a.redirectURI, rawIDToken, token.RefreshToken, claimData, a)
}
